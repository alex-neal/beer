...
For most of the beers shown, we can say that the calculated average rating is probably within a margin of 0.1 from the unknown "true" rating. The margin for Yellow Bus is a bit larger, while the Citra DIPA and Cantillon Blåbær Lambik margins are smaller. 
